...
import DialogSewaAttendenceForm from "./SewaAttendenceForm";
...
const SewaAttendence = () => {
  ...
  const [isSewaAttendenceForm, setIsSewaAttendenceForm] = useState(false);
  ...
  return (
    <>
      <div className="bgCard">
        ...
        <div style={{ display: "flex", flexWrap: "wrap" }}>
          ...
          <div className="markAttendence">
            ...
            <h4
              ...
              onClick={() => setIsSewaAttendenceForm(true)}
            >
              Mark Attendence
            </h4>
          </div>
        ...
        <DialogSewaAttendenceForm
          dialogOpen={isSewaAttendenceForm}
          dialogClose={setIsSewaAttendenceForm}
        />
