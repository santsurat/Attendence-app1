...
import DialogFieldAttendenceForm from "./FieldAtendenceForm";
...
const FieldAttendence = () => {
  // const navigate = useNavigate();
  const [isOpen, setIsOpen] = useState(false);
  const [isEnquiryOpen, setIsEnquiryOpen] = useState(false);
  const [isFieldAttendenceForm, setIsFieldAttendenceForm] = useState(false);
  ...
  return (
    <>
      <div className="bgCard">
        ...
        <div style={{ display: "flex", flexWrap: "wrap" }}>
          ...
          <div className="markAttendence">
            ...
            <h4
              ...
              onClick={() => setIsFieldAttendenceForm(true)}
            >
              Mark Attendence
            </h4>
          </div>
        ...
        <DialogFieldAttendenceForm
          dialogOpen={isFieldAttendenceForm}
          dialogClose={setIsFieldAttendenceForm}
        />
...
export default FieldAttendence;
